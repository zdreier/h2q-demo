...
const DATA = {
  ...
  flags: [
    {
      ...
      detail: "Flow of 0.12 GPM sustained for 3+ hours (12:00 am – 3:00 am). Detected via consecutive hourly reads with no zero-flow interval. Likely a running toilet or slow leak.",
  ...
  leakDetection: {
    ...
    durationHrs: 3.2,
    flowRateGpm: 0.12,
    estimatedWasteGal: 23,
    history: [
      { date: "Mar 27", status: "active",   durationHrs: 3.2, wasteGal: 23, resolvedAt: null },
